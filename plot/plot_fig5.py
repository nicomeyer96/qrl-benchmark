...
if __name__ == '__main__':
    ...
    models = ['Q[10-4]', 'C[16-2]', 'Q[14-4]', 'C[32-2]', 'C[64-2]']
    models_text = ['313', '387', '437', '1283', '4611']
    models_label = ['Quantum (10-4)', 'Classical (16-2)', 'Quantum (14-4)', 'Classical (32-2)', 'Classical (64-2)']
    models_ids = [range(100), range(100), range(100), range(100), range(100)]
    models_color = [COLORS[m] for m in ['quantum_model', 'classical_model', 'quantum_model', 'classical_model', 'classical_model']]
    models_marker = ['o', '^', 'H', '<', '>']
    ...
    # save figure
    path = os.path.join(os.path.dirname(__file__), 'plots', f'fig5.pdf')
